...
그 후, 날씨와 상황에 맞는 아웃핏을 추천받고, 추천된 아웃핏에 대한 리뷰를 남길 수 있습니다.
...
"입기 좋은 날"은 이런 기상 상황에 맞춰 의상과 함께 준비물까지 추천하여 사용자들이 외출 시 필요한 모든 요소를 놓치지 않도록 도와줍니다.
...
15℃는 추울거라 생각해서 겉옷을 준비했으나 더워서 짐만 되거나, 더울거라 생각해서 겉옷을 준비하지 않아 하루종일 추위에 떨었던 경험도 있을 것입니다.
<br>
...
| 이름      | 회고 내용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **박상현** | 새로운 기능을 해보진 않았지만 CRUD를 다시 한번 복습할 수 있어서 좋았던 것 같다. 또한 짧은 시간이었지만 백엔드와 프론트엔드까지 하게 되었는데, 전보다 속도가 붙어서 실력이 조금은 향상 된 것 같다.다만 아직 데이터베이스의 연관관계를 제대로 체크하지 못해서 jpa방식으로 조회를 하는 부분에서 어려웠다. 프론트엔드도 아직 컨테이너를 나눠서 CSS를 꾸미는 모습이 제대로 반영되지 않은 것 같아서 아쉽다. 데브옵스는 아직 이해도가 부족한 것 같아서 혼자서 짧게라도 다시 한번 해봐야겠다는 생각을 했다. 이번엔 짧은 기간이었지만 완성도가 높았는데 팀원들이 어려운 부분을 잘 해주고 도와준 부분이 큰 것 같다. 다음 프로젝트때는 새로운 기능이나 내가 실패했던 기능을 다시 한번 도전해보고 싶다.                                                                                                                                                                                                                                                                                               |
| **연건창** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **윤지영** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
